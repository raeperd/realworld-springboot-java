...
class ArticleRepositoryTest {
    ...
    void when_save_same_tag_from_another_article_expect_saved_successfully() {
        ...
        final var article = new Article(ArticleTitle.of("title"), "description", "body", Set.of(tagToSave, new Tag("other-tag")));
        final var articleWithSameTag = new Article(ArticleTitle.of("title"), "description", "body", Set.of(tagToSave));
